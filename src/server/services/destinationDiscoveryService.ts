...
const SYNONYMS: Record<string, string[]> = {
  ...
  sea: ['beach', 'island'],
  island: ['island', 'beach'],
  desert: ['desert', 'salt-desert', 'white-desert', 'cold-desert', 'dunes'],
  forest: ['forest', 'pine-forest', 'shola-forest'],
  lake: ['lake', 'lagoon'],
  valley: ['mountains', 'meadows'],
  // NOT 'nature'. It is tagged on half the catalogue, so expanding into it
  // made Kashmir claim "backwaters scenery, as you described" and score 65%
  // on a waterfall query. An expansion is only valid when the target tag
  // implies the source concept.
  ...
  rain: ['rain', 'monsoon', 'misty'],
  monsoon: ['rain', 'monsoon', 'misty'],
  food: ['street-food', 'seafood', 'biryani'],
  shopping: ['shopping', 'bazaar', 'market'],
  yoga: ['yoga', 'meditation', 'ayurveda'],
  meditation: ['meditation', 'yoga', 'monastery'],
  ayurveda: ['ayurveda', 'wellness', 'yoga'],
  wildlife: ['wildlife', 'safari', 'tiger', 'rhino', 'asiatic-lion', 'elephant'],
  safari: ['safari', 'wildlife', 'jeep-safari'],
  coffee: ['coffee', 'coffee-plantation'],
