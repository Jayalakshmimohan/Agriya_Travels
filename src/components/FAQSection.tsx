          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-colors ${isOpen ? 'bg-theme-gold text-white' : 'bg-slate-100 dark:bg-theme-border/50 text-slate-400'}`}>
